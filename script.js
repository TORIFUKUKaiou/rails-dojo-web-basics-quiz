const questions = [
  ...
  {
    category: 'ブラウザとサーバ',
    text: 'URLを開くとき、ブラウザが行うこととして正しいものはどれですか。',
  ...
  {
    category: 'HTML',
    text: 'HTMLの説明として正しいものはどれですか。',
    choices: ['ブラウザが読んで画面を表示するための文書', 'サーバの住所だけを表す文字列', 'Rubyの繰り返し専用の書き方', 'データベースに保存する表'],
    answer: [0],
    explanation: 'HTMLは、ブラウザが読んでWebページの画面を表示するための文書です。',
  },
  {
    category: 'HTML',
    text: '次のHTMLで、画面に表示される中身を書く場所はどれですか。',
    code: '<html>\n  <head>\n    <title>ページのタイトル</title>\n  </head>\n  <body>\n    <h1>大きな見出し</h1>\n    <p>本文です。</p>\n  </body>\n</html>',
    choices: ['body', 'head', 'title', 'html'],
    answer: [0],
    explanation: '画面に表示される見出しや本文は、主に body の中に書きます。',
  },
  {
    category: 'HTML',
    text: '次のHTMLで、ページの情報を書く場所はどれですか。',
    code: '<html>\n  <head>\n    <title>ページのタイトル</title>\n  </head>\n  <body>\n    <h1>大きな見出し</h1>\n  </body>\n</html>',
    choices: ['head', 'body', 'h1', 'p'],
    answer: [0],
    explanation: 'head は、ページのタイトルなど、ページの情報を書く場所です。',
  },
  {
    category: 'HTML',
    text: 'h1、h2、h3 は何を表すタグですか。',
    choices: ['見出し', '段落', '送信先', 'HTTPメソッド'],
    answer: [0],
    explanation: 'h1、h2、h3 は見出しを表すタグです。数字が小さいほど大きな見出しです。',
  },
  {
    category: 'HTML',
    text: 'p は何を表すタグですか。',
    choices: ['文章の段落', 'ページの住所', '大きな見出し', 'サーバへのリクエスト'],
    answer: [0],
    explanation: 'p は paragraph の p で、文章の段落を表します。',
  },
  {
    category: 'HTML',
    text: 'ブラウザで右クリックして「ページのソースを表示」を選ぶと、主に何を確認できますか。',
    choices: ['そのページのHTML', 'EC2のインスタンスタイプ', 'Rubyの変数一覧', 'データベースの中身'],
    answer: [0],
    explanation: 'ページのソースを表示すると、ブラウザが受け取ったHTMLを確認できます。',
  },
  {
    category: 'HTML',
    text: '次のHTMLで、いちばん大きな見出しとして読むタグはどれですか。',
    code: '<body>\n  <h1>お知らせ</h1>\n  <h2>今日の予定</h2>\n  <p>13時から授業です。</p>\n</body>',
    choices: ['h1', 'h2', 'p', 'body'],
    answer: [0],
    explanation: 'h1 は、ページ内の大きな見出しを表します。',
  },
  {
    category: 'HTML',
    text: 'Webページを開いたとき、HTMLはどの流れでブラウザへ届きますか。',
    choices: ['サーバがレスポンスとして返す', 'ブラウザがデータベースへ直接保存する', 'URLが自動でRubyに変換する', 'CSSがサーバへログインする'],
    answer: [0],
    explanation: 'ブラウザがリクエストを送り、サーバがHTMLなどをレスポンスとして返します。',
  },
  {
    category: 'URL',
