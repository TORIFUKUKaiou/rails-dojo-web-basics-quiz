const questions = [
  ...
  },
  {
    ...
    text: '「記事一覧をください」はどちらに近いですか。',
    choices: ['リクエスト', 'レスポンス', 'ルーティング', 'アクション'],
    answer: [0],
    explanation: '「ください」はブラウザからサーバへのお願いです。',
  },
  {
    category: 'リクエストとレスポンス',
    text: '「記事一覧のHTMLを返します」はどちらに近いですか。',
    choices: ['リクエスト', 'レスポンス', 'URL', 'フォーム'],
    answer: [1],
    explanation: 'サーバがブラウザへ返す返事がレスポンスです。',
  },
  {
    category: 'リクエストとレスポンス',
    text: '「ログイン情報を送ります」はどちらに近いですか。',
    choices: ['リクエスト', 'レスポンス', '画面表示', 'CSS'],
    answer: [0],
    explanation: 'フォームに入力した情報をサーバへ送るため、リクエストです。',
  },
  {
    category: 'リクエストとレスポンス',
    text: '「送信完了画面のHTMLを返します」はどちらに近いですか。',
    choices: ['リクエスト', 'レスポンス', 'パス', 'HTTPメソッド'],
    answer: [1],
    explanation: 'HTMLを返すのはサーバからブラウザへのレスポンスです。',
  },
  {
    category: 'リクエストとレスポンス',
